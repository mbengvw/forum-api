...
describe('ThreadRepositoryPostgres', () => {
  ...
  describe('addThread', () => {
    it('should persist new thread and return added thread correctly', async () => {
      ...
      const foundThreads = await ThreadsTableTestHelper.findThreadById('thread-123');
      expect(foundThreads).toBeDefined();
      expect(foundThreads.id).toEqual('thread-123');
      expect(foundThreads.title).toEqual(newThread.title);
      expect(foundThreads.body).toEqual(newThread.body);
      expect(foundThreads.owner).toEqual(newThread.owner);
      expect(foundThreads.date).toBeDefined();
    });
  });
